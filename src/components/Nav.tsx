  ...
  return (
    ...
    >
      <div className="mx-auto flex h-full max-w-[1200px] items-center justify-between px-6">
        ...
        <button
          type="button"
          className="inline-flex h-11 min-h-[44px] w-11 min-w-[44px] items-center justify-center rounded-md lg:hidden hover:bg-black/[0.06] transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--color-primary)"
