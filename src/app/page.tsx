...
const proofMetrics = [
  { stat: "3.2×", label: "average pipeline increase across growth sprints" },
...
const outcomes = [
  {
    ...
    detail:
      "11-week sprint for a Series A fintech. Target was 2×. Exceeded by restructuring the ICP and cutting two underperforming channels.",
  },
  {
    metric: "−28% customer acquisition cost",
    detail:
      "Signal audit found budget concentration in low-signal channels. Reallocation took three weeks. Results held at the six-month review.",
  },
  {
    metric: "4× faster sales cycle",
    detail:
      "Content rebuilt around buying signals, not awareness. Average deal time dropped from 90 days to 22.",
  },
];
...
export default function HomePage() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden -mt-16 py-32 px-6">
        <HeroShader />
        <div className="relative mx-auto max-w-[1200px]">
          <h1
            className="text-[40px] md:text-[56px] lg:text-[64px] font-bold leading-[1.05] tracking-[-0.03em] max-w-[700px] mb-6"
            style={{ color: "#ffffff" }}
          >
